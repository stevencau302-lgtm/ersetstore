      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="container-x flex items-center gap-2 sm:gap-4 py-3 sm:py-4">
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 ml-auto">
            <Link to="/wishlist" aria-label="Wishlist" className="grid size-9 sm:size-10 place-items-center rounded-xl text-gray-700 hover:text-brand-500 hover:bg-gray-50 transition-colors">
